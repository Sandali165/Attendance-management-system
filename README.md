...
GitHub → Jenkins → Maven Build → Docker Build → AWS ECR
...
The Docker image generated by Jenkins is automatically pushed to Amazon Elastic Container Registry (ECR).

Repository URI:

```text
491979259412.dkr.ecr.eu-north-1.amazonaws.com/attendance-app
```
